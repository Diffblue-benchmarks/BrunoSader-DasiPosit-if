 ...
 * @author brunosader
 */
@WebServlet(name = "ActionHistorique", urlPatterns = {"/ActionHistorique"})
public class ActionHistorique extends Action {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActionHistorique</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActionHistorique at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public void act(HttpServletRequest request) {
        ...
        request.setAttribute("conversations", mesConversations);
    }
}
