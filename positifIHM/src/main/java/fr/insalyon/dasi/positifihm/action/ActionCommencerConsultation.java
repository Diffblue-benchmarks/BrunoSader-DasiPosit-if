 ...
 * @author brunosader
 */
@WebServlet(name = "ActionCommencerConsultation", urlPatterns = {"/ActionCommencerConsultation"})
public class ActionCommencerConsultation extends Action {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActionCommencerConsultation</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActionCommencerConsultation at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public void act(HttpServletRequest request) {
        ...
        s.demanderVoyance(monClient,unMedium);
    }
}
