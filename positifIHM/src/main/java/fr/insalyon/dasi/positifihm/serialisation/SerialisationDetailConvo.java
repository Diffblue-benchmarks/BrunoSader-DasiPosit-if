 ...
 * @author rgall
 */
@WebServlet(name = "SerialisationDetailConvo", urlPatterns = {"/SerialisationDetailConvo"})
public class SerialisationDetailConvo extends Serialisation {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SerialisationDetailConvo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SerialisationDetailConvo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public void serialize(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try (PrintWriter out = response.getWriter()) {
            ...
            jsonConvoContainer.add("ConversationsMed", jsonArrayConvo);
