 ...
 * @author brunosader
 */
@WebServlet(name = "ActionGenererVoyance", urlPatterns = {"/ActionGenererVoyance"})
public class ActionGenererVoyance extends Action {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActionGenererVoyance</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActionGenererVoyance at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    public void act(HttpServletRequest request) {
        int idConvo = Integer.parseInt(request.getParameter("idConvo"));
