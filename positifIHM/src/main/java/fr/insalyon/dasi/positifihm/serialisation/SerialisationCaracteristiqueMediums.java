 ...
 * @author brunosader
 */
@WebServlet(name = "SerialisationCaracteristiqueMediums", urlPatterns = {"/SerialisationCaracteristiqueMediums"})
public class SerialisationCaracteristiqueMediums extends Serialisation {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SerialisationCaracteristiqueMediums</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SerialisationCaracteristiqueMediums at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
