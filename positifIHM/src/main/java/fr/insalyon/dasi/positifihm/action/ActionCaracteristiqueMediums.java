 ...
 * @author brunosader
 */
@WebServlet(name = "ActionCaracteristiqueMediums", urlPatterns = {"/ActionCaracteristiqueMediums"})
public class ActionCaracteristiqueMediums extends Action {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActionCaracteristiqueMediums</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActionCaracteristiqueMediums at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
